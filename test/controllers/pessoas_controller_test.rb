...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { data_nasc: @pessoa.data_nasc, nome: @pessoa.nome, pais: @pessoa.pais, sexo: @pessoa.sexo }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { data_nasc: @pessoa.data_nasc, nome: @pessoa.nome, pais: @pessoa.pais, sexo: @pessoa.sexo }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
